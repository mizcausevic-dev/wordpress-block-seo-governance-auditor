...
try {
    ...
    $targets = @(
        ...
        @{ Url = "http://127.0.0.1:$port/block-audit"; File = "02-block-audit-proof.png"; Size = "1600,1500" },
        @{ Url = "http://127.0.0.1:$port/schema-opportunities"; File = "03-schema-opportunities-proof.png"; Size = "1600,1180" },
